...
'''
This code is for scoring the output of a model against a reference key.
Source code is from the Natural Language Processing course @NYU

Requirements:
Score(key, response)
Both files should consist of lines of the form:   token \t tag
All sentences are separated by empty lines
